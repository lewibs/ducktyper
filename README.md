...
| initDuckorateOptions(obj) | this is used to update the default options that are used when a new decorator is initialized using duckorate. |
...
| type: Enum |  is the type of decorator that will be used when passed into duckorate, can be class, property, or parameter | 
<br/>
